...
LastEditTime: 2025-05-10 14:09:33
...
def get_fid():
    real_images_folder = "./experiments/real_images_5points"  # 真实图像文件夹路径
    generated_images_folder = "./experiments/generated_images_5points"  # 生成图像文件夹路径
...
if __name__ == "__main__":
    ...
    for j in range(id):
        ...
        image.save("./experiments/generated_images_5points/{}.png".format(j + 1))
        image2.save("./experiments/real_images_5points/{}.png".format(j + 1))
